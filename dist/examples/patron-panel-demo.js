...
import { createPatronPanel, createPatronPanelUI } from '../components/patron-panel';
...
export class PatronPanelDemo {
    constructor() {
        this.patronPanel = null;
        this.patronPanelUI = null;
        // Initialize services
     ...
     */
    createPatronPanelUI(containerId) {
        if (!this.patronPanel) {
 ...
 */
export async function createPatronPanelDemo() {
 ...
 */
export async function runPatronPanelDemo() {
...
//# sourceMappingURL=patron-panel-demo.js.map