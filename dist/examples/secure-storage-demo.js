...
export class SecureStorageDemo {
    ...
    async demonstrateCriticalDataCaching() {
    ...
    async demonstrateOfflineFunctionality() {
    ...
    async demonstrateStorageManagement() {
...
export async function runSecureStorageDemo() {
...
if (typeof window !== 'undefined') {
    // Browser environment
    window.runSecureStorageDemo = runSecureStorageDemo;
...
//# sourceMappingURL=secure-storage-demo.js.map