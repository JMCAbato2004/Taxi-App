...
export class PatronPanelUI {
     ...
     */
    renderTaxistaCard(taxista, associations) {
     ...
     */
    renderAvailableTaxistaCard(taxista) {
        return `
     ...
     */
    async confirmCreateAssociation(taxistaId, nombre, numeroTaxista) {
     ...
     */
    async confirmRemoveAssociation(associationId, taxistaNombre) {
 ...
 */
export function createPatronPanelUI(config) {
    return new PatronPanelUI(config);
}
//# sourceMappingURL=patron-panel-ui.js.map