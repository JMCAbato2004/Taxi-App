...
describe('SecureStorageService', () => {
    ...
    beforeEach(() => {
        ...
        mockCryptoUtils.encryptSensitiveData = jest.fn().mockImplementation(async (data) => {
        ...
        mockCryptoUtils.decryptSensitiveData = jest.fn().mockImplementation(async (encryptedData) => {
