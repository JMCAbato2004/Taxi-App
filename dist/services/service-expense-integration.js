...
export class ServiceExpenseIntegrationService {
    constructor(roleService, reconciliationService, getCurrentUser) {
     ...
     */
    async updateService(serviceId, updates, existingServices) {
        const currentUser = this.getCurrentUser();
        if (!currentUser) {
            throw new AuthError(AuthErrorCode.SESSION_EXPIRED, 'Usuario no autenticado');
        }
     ...
     * Requirements: 5.3, 5.5 - Associate operations with correct user and apply filtering
     */
    async updateExpense(expenseId, updates, existingExpenses) {
        const currentUser = this.getCurrentUser();
        if (!currentUser) {
            throw new AuthError(AuthErrorCode.SESSION_EXPIRED, 'Usuario no autenticado');
        }
     ...
     * Requirements: 5.3, 5.5 - Associate operations with correct user and apply filtering
     */
    async deleteService(serviceId, existingServices) {
        const currentUser = this.getCurrentUser();
        if (!currentUser) {
            throw new AuthError(AuthErrorCode.SESSION_EXPIRED, 'Usuario no autenticado');
        }
     ...
     * Requirements: 5.3, 5.5 - Associate operations with correct user and apply filtering
     */
    async deleteExpense(expenseId, existingExpenses) {
        const currentUser = this.getCurrentUser();
        if (!currentUser) {
            throw new AuthError(AuthErrorCode.SESSION_EXPIRED, 'Usuario no autenticado');
        }
     ...
     */
    validateOperationPermissions(context) {
        const currentUser = this.getCurrentUser();
     ...
     */
    getAggregatedStats(services, expenses) {
        const currentUser = this.getCurrentUser();
    ...
    wrapStorageOperations(storageManager) {
        ...
        return {
            ...
            updateServiceWithAuth: async (id, updates) => {
            ...
            updateExpenseWithAuth: async (id, updates) => {
     ...
     */
    addAuthContextToService(service) {
        const currentUser = this.getCurrentUser();
        if (!currentUser) {
            return {
                ...service,
     ...
     */
    addAuthContextToExpense(expense) {
        const currentUser = this.getCurrentUser();
        if (!currentUser) {
            return {
                ...expense,
...
//# sourceMappingURL=service-expense-integration.js.map