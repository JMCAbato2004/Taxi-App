...
export class CryptoUtils {
    async hashPassword(password) {
        try {
            ...
            throw new AuthError(AuthErrorCode.NETWORK_ERROR, 'Error al encriptar contraseña', error);
        }
    }
    ...
    async encryptSensitiveData(data, key) {
        ...
        try {
            ...
            throw new AuthError(AuthErrorCode.NETWORK_ERROR, 'Error al encriptar datos', error);
        }
    }
    async decryptSensitiveData(encryptedData, key) {
        ...
        try {
            ...
            throw new AuthError(AuthErrorCode.NETWORK_ERROR, 'Error al desencriptar datos', error);
        }
    }
