...
import { AuthError, AuthErrorCode, ROLE_PERMISSIONS } from '../types';
export class JWTUtils {
    ...
    verifyToken(token) {
        try {
            ...
            throw new AuthError(AuthErrorCode.INVALID_TOKEN, 'Token inválido o expirado');
        }
    }
    verifyRefreshToken(token) {
        try {
            ...
            throw new AuthError(AuthErrorCode.INVALID_TOKEN, 'Refresh token inválido o expirado');
        }
    }
