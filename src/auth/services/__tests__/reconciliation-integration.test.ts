...
import { ReconciliationIntegrationService, ServiceData, ExpenseData, ReconciliationData } from '../reconciliation-integration';
...
describe('ReconciliationIntegrationService', () => {
  let service: ReconciliationIntegrationService;
  ...
  beforeEach(() => {
    ...
    service = new ReconciliationIntegrationService(
  ...
  describe('wrapStorageOperations', () => {
    ...
    it('should enrich data when saving', () => {
      ...
      expect(mockStorageManager.saveService).toHaveBeenCalledWith(
