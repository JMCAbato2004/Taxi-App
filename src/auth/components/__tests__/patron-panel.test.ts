...
describe('PatronPanel', () => {
  ...
  let patronPanel: PatronPanel;
  let config: PatronPanelConfig;
  let mockPatron: User;
  let mockTaxistas: User[];
  ...
  describe('Association Management', () => {
    ...
    it('should create association successfully', async () => {
      ...
      expect(config.onSuccess).toHaveBeenCalledWith(
        expect.stringContaining('Asociación creada con María García')
      );
    ...
    it('should remove association successfully', async () => {
      ...
      if (associationId) {
        ...
        expect(success).toBe(true);
        expect(config.onSuccess).toHaveBeenCalledWith(
          expect.stringContaining('Asociación con')
        );
