...
describe('MiddlewareIntegration', () => {
  let integration: MiddlewareIntegration;
  let mockMiddleware: jest.Mocked<AuthorizationMiddleware>;
  let patronUser: User;
  ...
  describe('requirePermission', () => {
    ...
    it('should encrypt sensitive data when requested', async () => {
      ...
      expect(mockMiddleware.encryptSensitiveData).toHaveBeenCalledWith(
        { name: 'Test', email: 'test@example.com' },
        { encryptFields: ['email'], skipEncryption: false }
      );
    ...
    it('should use default values for optional parameters', async () => {
      ...
      await integration.requirePermission(
        patronUser,
        { permission: Permission.VIEW_ALL_DRIVERS },
        mockOperation
      );
  ...
  describe('validateAndFilterData', () => {
    it('should filter data when authorization succeeds', async () => {
      ...
      const result = await integration.validateAndFilterData(
        patronUser,
        testData,
    ...
    it('should throw error for unauthenticated user', async () => {
      await expect(
        integration.validateAndFilterData(
          null,
          [],
    ...
    it('should use default resource name', async () => {
      ...
      await integration.validateAndFilterData(
        patronUser,
        [],
        Permission.VIEW_ALL_DRIVERS
      );
