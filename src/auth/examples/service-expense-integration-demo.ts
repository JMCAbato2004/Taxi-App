...
export class ServiceExpenseIntegrationDemo {
  ...
  private integrationService: ServiceExpenseIntegrationService;
  ...
  constructor() {
    ...
    this.reconciliationService = new ReconciliationIntegrationService(
      this.roleService,
      () => this.authService.getCurrentUser()
    );
    this.integrationService = new ServiceExpenseIntegrationService(
      this.roleService,
   ...
   */
  async demoPatronServiceManagement(): Promise<void> {
   ...
   */
  async demoTaxistaServiceManagement(): Promise<void> {
   ...
   */
  async demoExpenseManagement(): Promise<void> {
   ...
   */
  async demoPermissionValidation(): Promise<void> {
   ...
   */
  async demoStorageIntegration(): Promise<void> {
...
if (typeof window !== 'undefined') {
  (window as any).ServiceExpenseIntegrationDemo = ServiceExpenseIntegrationDemo;
}
