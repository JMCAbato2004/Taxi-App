...
import { getConnectionManager, ConnectionManager, initializeDatabase } from './connection';
...
export class DatabaseUtils {
   ...
   */
  static async setupDatabase(config?: DatabaseConfig): Promise<ConnectionManager> {
   ...
   */
  static async healthCheck(config?: DatabaseConfig): Promise<{
    connected: boolean;
    schemaValid: boolean;
    error?: string;
  }> {
   ...
   */
  static async resetDatabase(config?: DatabaseConfig): Promise<void> {
    const manager = getConnectionManager(config);
   ...
   */
  static async backupSchema(_config?: DatabaseConfig): Promise<string> {
   ...
   */
  static async getStatistics(config?: DatabaseConfig): Promise<{
    totalUsers: number;
